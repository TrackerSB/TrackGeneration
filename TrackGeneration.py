...
def writeCriteria(track0):
    ...
    file.write(f"<ai><position id=\"egoPosition\"/><speed id=\"egoSpeed\"/><steeringAngle id=\"egoSteeringAngle\"/><camera id=\"egoFrontCamera\" width=\"800\" height=\"600\" fov=\"60\" direction=\"FRONT\"/><lidar id=\"egoLidar\" radius=\"200\"/><roadCenterDistance id=\"egoLaneDist\"/></ai></participant></participants><success><scArea participant=\"ego\" points=\"({succ1X},{succ1Y});({succ2X},{succ2Y});({succ3X},{succ3Y});({succ4X},{succ4Y})\"/></success><failure><or><scDamage participant=\"ego\"/><scLane participant=\"ego\" onLane=\"offroad\"/></or></failure></criteria>")
    file.close()
